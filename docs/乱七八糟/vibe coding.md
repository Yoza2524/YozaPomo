...
> - 如果对我vibe coding的具体项目感兴趣，可以在[YozaPomo-Github](https://github.com/Yoza2524/YozaPomo)或主页查看 代码 和 我的心路历程。
...
>
> 1. 记注 验证过的bug和bug修改日志一起提交… …，保存到Claude.md。
>
> 1. 记得 Git提交每次只提交一件事… …，保存到Claude.md。
>
> 1. 记得 提交时只提交改动相关的文档… …，保存到Claude.md。
>
> 2. 记得 我是你的老大… …，保存到Claude.md。
>
> 3. 记得 疯狂星期四，v我50块… …，保存到Claude.md。
>
>    … …
