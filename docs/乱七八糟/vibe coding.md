...
- 如果你和我一样，生成了开发的计划，可以尝试让他再次检查
  ...
  > 根据需求再次检查开发流程，是否有什么问题，尽量让我每一步能在图形化界面测试

- 如果没有生成，这时候就可以根据项目的大小生成开发计划了

  > 规划开发的步骤，(一次性不要做太多)，尽量让我每一步能在图形化界面测试
...
> 我将在docs/需求文档/目录下新建文件来记录bug和优化项。每次只做一个做完交由我验证，验证后我修改需求文档下的状态，然后你在开发日志目录下对应文件记录并提交
